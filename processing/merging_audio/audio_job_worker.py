...
def watch_jobs_folder(
    jobs_folder: str = "jobs", poll_interval: float = 5.0, run_once: bool = False
):
    """
        ...
        while True:
            ...
            if pending_jobs:
                ...
                if run_once:
                    ...
                    print(
                        f"[INFO] No pending jobs. Waiting {poll_interval}s...", end="\r"
                    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Audio Job Worker - Process audio merging jobs"
    )
    parser.add_argument(
        "--jobs-folder",
        type=str,
